...
export default function SendSMSPage() {
  ...
  const [template, setTemplate] = useState(
    "Dear {name}, we have received your payment of LKR {amount} for Loan #{loanId} on {date}. Your remaining balance is LKR {settlement}.New Town Abagasdowa.Please contact us via WhatsApp at +94 70 555 8880.Thank you!"
  );
